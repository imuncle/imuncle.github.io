...
//		document.getElementsByTagName('body')[0].addEventListener("touchstart", touchEvent, false);
//		document.getElementsByTagName('body')[0].addEventListener("touchend", touchEvent, false);
//		document.getElementsByTagName('body')[0].addEventListener("touchmove", touchEvent, false)
	}
